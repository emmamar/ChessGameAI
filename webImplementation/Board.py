...
class Board:
    ...
    def createPiece(self, item):
        piece_map = {"00":None, "PB":Pawn.Pawn("B"), "KB":King.King("B"), "QB":Queen.Queen("B"), "BB":Bishop.Bishop("B"), "RB":Knight.Knight("B"), "CB":Castle.Castle("B"), "PW":Pawn.Pawn("W"), "KW":King.King("W"), "QW":Queen.Queen("W"), "BW":Bishop.Bishop("W"), "RW":Knight.Knight("W"), "CW":Castle.Castle("W")}
